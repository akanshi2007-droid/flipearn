...
export default function Sidebar(){
  return(
    <aside className="w-20 md:w-64 bg-white border-r min-h-screen flex flex-col">
      <div className="p-5">
        <h1 className="font-bold text-xl text-violet-600">
          flip<span className="text-black hidden md:inline">earn.</span>
        </h1>
      </div>
      <div className="flex flex-col items-center py-6">
        ...
        <p className="hidden md:block mt-2 text-sm font-medium">John Doe</p>
      </div>
